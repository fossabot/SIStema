...
urlpatterns = [
    ...
    url(r'^check/(?P<group_name>[^/]+)/teachers/$',
        views.checking_group_teachers,
        name='checking_group_teachers'),
    url(r'^check/(?P<group_name>[^/]+)/teacher(?P<teacher_id>[^/]+)/checks/$',
        views.teacher_checks,
        name='teacher_checks'),
    url(r'^check/(?P<group_name>[^/]+)/teacher(?P<teacher_id>[^/]+)/task(?P<task_id>[^/]+)/checks/$',
