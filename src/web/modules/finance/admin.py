...
class PaymentAmountAdmin(sistema.admin.ModelAdmin):
...
class DiscountAdmin(sistema.admin.ModelAdmin):
...
class DocumentTypeAdmin(sistema.admin.ModelAdmin):
...
class DocumentAdmin(sistema.admin.ModelAdmin):
...
class QuestionnaireVariantDocumentGenerationConditionAdmin(
        sistema.admin.ModelAdmin
):
