...
urlpatterns = [
    ...
    url(r'^download_archive/$', views.email_archive, name='email_archive'),
    url(r'^write/$', views.write, name='write'),
    url(r'^write/(?P<recipient_hash>[^/]+)/$', views.write_to, name='write_to'),
    url(r'^compose/', views.compose, name='compose'),
    url(r'^contacts/search', views.contacts_search, name='contacts_search'),
    ...
    url(r'^generate_emails/', views.generate_emails, name='generate_emails'),
