...
urlpatterns = [
    ...
    url(r'^settings/(?P<settings_item_id>[^/]+)$', views.school_settings_item_edit, name='school_settings_list'),
    url(r'^(?P<session_name>[^/]+)/settings/(?P<settings_item_id>[^/]+)$', views.session_settings_item_edit, name='session_settings_list'),
    # Modules
